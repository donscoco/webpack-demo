...
module.exports = {
  entry: {
    ...
    'user-login-wechat'                 : ['./src/page/user-login-wechat/index.js'],
    'user-login-wechat-callback'        : ['./src/page/user-login-wechat-callback/index.js'],
  ...
  plugins: [
   ...
   // 把css单独打包到文件里
    ...
    new HtmlWebpackPlugin(getHtmlConfig('user-login-wechat', '微信登陆')),
    new HtmlWebpackPlugin(getHtmlConfig('user-login-wechat-callback', '微信登陆反馈')),
